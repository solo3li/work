...
export default function PromotionsVIPScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Promotions & VIP</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          <View style={styles.iconWrapper}>
            <Ionicons name="gift-outline" size={54} color={Colors.dark.tint} />
          </View>
          <Text style={styles.placeholderText}>Promotions & VIP</Text>
