...
export default function ProfileScreen() {
  const menuItems = [
    { icon: 'wallet', title: 'المحفظة', value: '450 ج.م' },
    { icon: 'heart', title: 'المفضلة' },
    { icon: 'settings', title: 'الإعدادات' },
    { icon: 'help-buoy', title: 'الدعم والنزاعات' },
    { icon: 'log-out', title: 'تسجيل الخروج', color: Colors.error },
  ];
